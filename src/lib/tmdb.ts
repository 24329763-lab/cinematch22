...
export const TRENDING: MoviePoster[] = [
  { id: "t1", title: "Ainda Estou Aqui", year: 2024, rating: 8.1, posterUrl: MOVIE_POSTERS["ainda-estou-aqui"], platforms: ["netflix"], genres: ["Drama", "Histórico"], matchPercent: 96, description: "Eunice Paiva reconstrói a vida após o desaparecimento do marido durante a ditadura militar brasileira. Uma história de resiliência e memória que atravessa décadas." },
  ...
  { id: "t3", title: "Duna: Parte 2", year: 2024, rating: 8.1, posterUrl: MOVIE_POSTERS["duna-2"], platforms: ["prime"], genres: ["Ficção Científica"], matchPercent: 89, description: "Paul Atreides se une aos Fremen para vingar sua família, enfrentando uma escolha entre o amor e o destino do universo." },
