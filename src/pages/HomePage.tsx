  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground leading-relaxed mb-4 max-w-sm mx-auto">
        Fale comigo sobre seus filmes favoritos e o que você curte — quanto mais eu souber, melhores serão as
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-[calc(100dvh-4rem)] overflow-y-auto pb-24 relative">
      ...
      {/* Default/Fallback sections for guests and users without personalization */}
      {(!hasPersonalization || !user) && !personalizationLoading && (
        <>
          <section className="mt-10">
            <SectionHeader icon={Flame} title="Em Alta" subtitle="O que todo mundo está vendo" />
            <HorizontalScroll>
          ...
          <section className="mt-10">
            <SectionHeader icon={Star} title="Recomendados" subtitle="Sugestões da nossa curadoria" />
            <HorizontalScroll>
              {FOR_YOU.map((movie, i) => (
                <PosterCard key={movie.id} movie={movie} index={i} onSelect={setSelectedMovie} />
              ))}
          ...
          <section className="mt-10">
            <SectionHeader icon={Clock} title="Saindo do Catálogo" subtitle="Última chance para assistir" />
            <HorizontalScroll>
          ...
          <section className="mt-10">
            <SectionHeader icon={Compass} title="Novos Lançamentos" subtitle="Acabaram de chegar" />
            <HorizontalScroll>
          ...
          <section className="mt-10">
            <SectionHeader icon={Globe} title="Originais Netflix" subtitle="Produções exclusivas" />
            <HorizontalScroll>
